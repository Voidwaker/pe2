...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      //  this is a temporary solution to refresh the page after login, so the header updates properly (will be replaced with a better solution when i got time to fix it)
      setTimeout(() => {
